    ...
    return (
        <>
            <div className="messages-output">
                ...
                {!user && <div className="alert alert-danger">Lütfen Tekrar Giriş Yapınız</div>}
            ...
            <Form onSubmit={handleSubmit}>
                <Row>
                    <Col md={11}>
                        <Form.Group>
                            <Form.Control type="text" placeholder="Mesajın" disabled={!user} value={message} onChange={(e) => setMessage(e.target.value)}></Form.Control>
                        </Form.Group>
                    </Col>
                    <Col md={1}>
